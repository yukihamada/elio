...
<p align="center">
  ...
  &nbsp;
  <img src="https://img.shields.io/badge/30+_AIモデル-2563EB?style=flat-square" alt="Models">
  &nbsp;
  <img src="https://img.shields.io/badge/MCP_13連携-7C3AED?style=flat-square" alt="MCP">
  &nbsp;
...
<p align="center">
  <img src="fastlane/screenshots_final/ja/iPhone 16 Pro Max-01_WelcomeScreen.png" width="18%" alt="ウェルカム">
  &nbsp;
  <img src="fastlane/screenshots_final/ja/iPhone 16 Pro Max-02_ChatSchedule.png" width="18%" alt="予定管理">
  &nbsp;
  <img src="fastlane/screenshots_final/ja/iPhone 16 Pro Max-03_ChatCode.png" width="18%" alt="コード支援">
  &nbsp;
  <img src="fastlane/screenshots_final/ja/iPhone 16 Pro Max-05_ChatPrivacy.png" width="18%" alt="プライバシー">
  &nbsp;
  <img src="fastlane/screenshots_final/ja/iPhone 16 Pro Max-08_Settings.png" width="18%" alt="モデル選択">
</p>
...
graph LR
    subgraph iPhone
        A["&#128241; 小型モデル<br>(Qwen3 1.7B)"]
    end

    subgraph ローカルネットワーク
        B["&#128246; Bonjour自動検出<br>+ 暗号化P2P"]
    end

    subgraph Mac
        C["&#128187; 大型モデル<br>(Qwen3 8B / 70B)"]
    end

    A <-->|"高速推論"| B <-->|"_eliochat._tcp"| C
```
